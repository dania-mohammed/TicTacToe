...
# main menu and end of the game menu 
class Menu:
# we don't have attributes that's why we don't need initilization method 
     def display_main_menu(self):
          ...
          while True:
            try:
                print('1. Start Game. \n2. Quit Game.')
                str_choice = input ('Eneter your choice "1" or "2":')
...
# soild principles , single responsibility principle 
...
class Game:
    ...
    def check_win(self):
        win_combination =[[0,1,2],[3,4,5],[6,7,8],  #rows
